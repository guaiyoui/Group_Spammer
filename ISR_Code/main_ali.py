...
# labLen = 96           # Number of labeled users (e.g., 5%)
# unLen = 36287          # Total number of users

labLen = 192           # Number of labeled users (e.g., 10%)
unLen = 36287          # Total number of users

labLen = 576           # Number of labeled users (e.g., 30%)
unLen = 36287          # Total number of users

labLen = 960           # Number of labeled users (e.g., 50%)
unLen = 36287          # Total number of users
...
def initialization():
    ...
    train_path = "/data1/jianweiw/LLM/Imputation/Fake_review_detection/Fake_Review_Detection/Group_Spammer/datasets/ali/Training_Testing/50percent/train_4.csv"
    try:
    ...
    test_path = "/data1/jianweiw/LLM/Imputation/Fake_review_detection/Fake_Review_Detection/Group_Spammer/datasets/ali/Training_Testing/50percent/test_4.csv"
    try:
    ...
    neighbor_path = "/data1/jianweiw/LLM/Imputation/Fake_review_detection/Fake_Review_Detection/Group_Spammer/datasets/ali/J01Network.txt"
    try:
...
def SaveResults():
    output_path = "../detection_results/ali/isr_predictions.txt"
    tp = fn = fp = tn = 0
    with open(output_path, "w") as fout:
    ...
    output_path_metrics = "../detection_results/ali/isr_metrics.txt"
