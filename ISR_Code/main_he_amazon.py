...
def SaveResults():
    output_path = f"../detection_results/he_amazon/{percentage}_isr_predictions.txt"
    tp = fn = fp = tn = 0
    with open(output_path, "w") as fout:
    ...
    output_path_metrics = f"../detection_results/he_amazon/{percentage}_isr_metrics.txt"
