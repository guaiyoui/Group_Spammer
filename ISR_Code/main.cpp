...
//     ifstream fin3("../Data/jaccard0.2.txt"); // all of user neighbors
    ...
    ifstream fin1("../Data/Training_Testing/1percent/train_5.csv");//dataset/one-portion/train_2.csv
    ifstream fin4("../Data/Training_Testing/1percent/test_5.csv");//dataset/5percent/test_1.csv
    ifstream fin3("../Data/jaccard0.2.txt"); // all of user neighbors
...
float MStep(float lambda, float d){
    ...
    ofstream fout("./spammer_results/prediction_1percents.txt");
