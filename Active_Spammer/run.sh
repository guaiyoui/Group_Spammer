...
CUDA_VISIBLE_DEVICES=5 python run_baselines.py --dataset he_amazon --model GCN_update --epoch 300 --strategy uncertainty --file_io 1 --lr 0.01 --hidden 32 --test_percents 50percent --data_path ../he_amazon/data/network/ --sample_global