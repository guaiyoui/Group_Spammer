...
# 计算5%的数量
train_size = int(len(combined_df) * 0.05)
...
new_train_df.to_csv('./Training_Testing/5percent/train_4.csv', index=False, sep=' ', header=False)
new_test_df.to_csv('./Training_Testing/5percent/test_4.csv', index=False, sep=' ', header=False)
