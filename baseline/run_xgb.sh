...
python -u xgb.py --feature_path ../datasets/ali/UserFeature.txt --train_csv ../datasets/ali/Training_Testing/5percent/train_4.csv --test_csv ../datasets/ali/Training_Testing/5percent/test_4.csv

python -u xgb.py --feature_path ../datasets/ali/UserFeature.txt --train_csv ../datasets/ali/Training_Testing/50percent/train_4.csv --test_csv ../datasets/ali/Training_Testing/50percent/test_4.csv


python -u xgb.py --feature_path ../datasets/ali/UserFeature.txt --train_csv ../datasets/ali/Training_Testing/10percent/train_4.csv --test_csv ../datasets/ali/Training_Testing/10percent/test_4.csv

python -u xgb.py --feature_path ../datasets/ali/UserFeature.txt --train_csv ../datasets/ali/Training_Testing/30percent/train_4.csv --test_csv ../datasets/ali/Training_Testing/30percent/test_4.csv

python -u xgb.py --feature_path ../datasets/amazon_cn/UserFeature.txt --train_csv ../datasets/amazon_cn/Training_Testing/5percent/train_5.csv --test_csv ../datasets/amazon_cn/Training_Testing/5percent/test_5.csv

python -u xgb.py --feature_path ../datasets/amazon_cn/UserFeature.txt --train_csv ../datasets/amazon_cn/Training_Testing/5percent/train_4.csv --test_csv ../datasets/amazon_cn/Training_Testing/5percent/test_4.csv