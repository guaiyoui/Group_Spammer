...
if __name__ == "__main__":
    ...
    output_path = './results/svm_predictions.txt'
    ...
    # 保存评估指标
    metrics_path = './results/svm_metrics.txt'
    ...
    output_path = os.path.join(target_dir, f"{percentage}_svm_predictions.txt")
    metrics_path = os.path.join(target_dir, f"{percentage}_svm_metrics.txt")
