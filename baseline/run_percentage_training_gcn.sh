...
# 基础路径
FEATURE_PATH="../datasets/amazon_cn/UserFeature.txt"
BASE_PATH="../datasets/amazon_cn/Training_Testing"

echo "开始顺序执行XGBoost训练..."
...
do
    ...
    # 执行训练命令
    python -u gcn.py \
        --edge_list ../datasets/amazon_cn/J01Network.txt \
